...
import demo.support.keycloak.KeycloakGrantedAuthoritiesConverter;
...
class JwtSecurityConfig {
    ...
    @Bean
    Converter<Jwt, Collection<GrantedAuthority>> keycloakGrantedAuthoritiesConverter(GrantedAuthoritiesMapper authoritiesMapper, KeycloakDataServiceProperties keycloakDataServiceProperties) {
        return new KeycloakGrantedAuthoritiesConverter(keycloakDataServiceProperties.getJwt().getClientId(), authoritiesMapper);
    }
