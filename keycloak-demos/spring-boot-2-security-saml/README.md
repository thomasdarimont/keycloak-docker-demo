...
Adapted from [vdenotaris/spring-boot-security-saml-sample](https://github.com/vdenotaris/spring-boot-security-saml-sample).
...
This example is also known to work with the [Keycloak](https://www.keycloak.org/) SAML Server (tested on 4.8.3.Final).
```
